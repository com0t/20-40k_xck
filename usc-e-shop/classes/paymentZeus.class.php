...
<?php			endif;
	...
	public function confirm_inform( $html, $payments, $acting_flg, $rand, $purchase_disabled ) {
		...
		case 'acting_zeus_card':
			...
			$zeus_card_option = ( isset( $_POST['zeus_card_option'] ) ) ? wp_unslash( $_POST['zeus_card_option'] ) : '';
			$zeus_token_value = ( isset( $_POST['zeus_token_value'] ) ) ? wp_unslash( $_POST['zeus_token_value'] ) : '';
		...
		case 'acting_zeus_conv':
			...
			$username_conv = ( isset( $_POST['username_conv'] ) ) ? wp_unslash( $_POST['username_conv'] ) : '';
			$html = '<form id="purchase_form" action="'.USCES_CART_URL.'" method="post" onKeyDown="if (event.keyCode == 13) {return false;}">
