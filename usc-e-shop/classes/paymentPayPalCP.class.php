...
jQuery( document ).ready( function( $ ) {
	...
	public function settlement_info_field_keys( $keys, $fields ) {
		if ( isset( $fields['acting'] ) && 'paypal_cp' == $fields['acting'] ) {
	...
	<tr>
		...
		<td>
			...
			<tr>
				...
				<td colspan="3"><?php esc_html_e( $ba_id ); ?></td>
			</tr>
			<tr>
...
<input name="usces_referer" type="hidden" id="usces_referer" value="<?php echo urlencode( $curent_url ); ?>" />
	...
	<table class="mem_info">
		<tr><th class="label"><?php _e( 'Billing Agreement ID', 'usces' ); ?></th><td class="col1"><?php echo esc_attr( $ba_id ); ?></td></tr>
	</table>
	</div>
		<?php
	}
