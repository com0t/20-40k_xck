...
<div class="postbox">
<h3><span><?php _e('Business settings','usces'); ?></span><a style="cursor:pointer;" onclick="toggleVisibility('business_setting');"> (<?php _e('explanation', 'usces'); ?>) </a></h3>
<div class="inside">
...
<div class="postbox">
<h3><span><?php _e('Shop setting', 'usces'); ?></span><a style="cursor:pointer;" onclick="toggleVisibility('shop_setting');"> (<?php _e('explanation', 'usces'); ?>) </a></h3>
<div class="inside">
<table class="form_table">
	<tr>
...
<table class="form_table">
	...
	<tr>
		...
		<td width="10"><input name="membersystem_point" id="membersystem_point_activate" type="radio" value="activate"<?php if($this->options['membersystem_point'] == 'activate') echo 'checked="checked"'; ?> /></td><td width="100"><label for="membersystem_point_activate"><?php _e('to use', 'usces'); ?></label></td>
		<td width="10"><input name="membersystem_point" id="membersystem_point_deactivate" type="radio" value="deactivate"<?php if($this->options['membersystem_point'] == 'deactivate') echo 'checked="checked"'; ?> /></td><td width="100"><label for="membersystem_point_deactivate"><?php _e('not to use', 'usces'); ?></label></td>
...
<div class="postbox">
<h3 id="payment_method_setting"><span><?php _e('payment method', 'usces'); ?></span><a style="cursor:pointer;" onclick="toggleVisibility('payment_setting');"> (<?php _e('explanation', 'usces'); ?>) </a></h3>
<div class="inside">
...
<div class="postbox">
<h3><span><?php _e('Common Options', 'usces'); ?></span></h3>
<div class="inside">
