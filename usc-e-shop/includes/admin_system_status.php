...
<div id="download_env_info">
    <button id="btn_download_env_info" class="button" ><?php echo esc_html_e( 'Download environment information', 'usces' ); ?></button>
</div>
...
<table class="wc_status_table widefat" cellspacing="0" >
    ...
    <tr>
        ...
        <td><?php echo ($welcart_information['email_attach_feature']) ? esc_html_e('Use','usces') : esc_html_e('Do not Use','usces'); ?></td>
    </tr>
    <?php if ( $welcart_information['email_attach_feature'] ): ?>
    <tr>
        <td data-export-label="Extensions of attachments"><?php esc_html_e( 'Extensions of attachments', 'usces' ); ?>:</td>
        <td><?php echo ($welcart_information['email_attach_file_extension']); ?></td>
    </tr>
    <tr>
        <td data-export-label="Maximum size of email attachment"><?php esc_html_e( 'Maximum size of email attachment', 'usces' ); ?>:</td>
        <td><?php echo ($welcart_information['email_attach_file_size']); ?> Mb</td>
    </tr>
    <?php endif; ?>
    <tr>
        <td data-export-label="HTML mail format"><?php esc_html_e('HTML mail format', 'usces'); ?>:</td>
        <td><?php echo ($welcart_information['add_html_email_option']) ? esc_html_e('Use','usces') : esc_html_e('Do not Use','usces'); ?></td>
    </tr>
    </tbody>
</table>
...
<table class="wc_status_table widefat" cellspacing="0">
    ...
    <tr>
        ...
        <td><?php echo ( $welcart_information['ganbare_activate_flag'] ) ?  esc_html_e( 'Enabled', 'usces' ) : esc_html_e( 'Disabled', 'usces' ); ?></td>
    </tr>
    <tr>
        <td data-export-label="Linkage Order Upadate"><?php esc_html_e( 'Linkage Order Upadate', 'usces' ); ?>:</td>
        <td><?php echo ( $welcart_information['stocklink_orderedit_flag'] ) ?  esc_html_e( 'Enabled', 'usces' ) : esc_html_e( 'Disabled', 'usces' ); ?></td>
    </tr>
    <tr>
        <td data-export-label="Linkage Order Collective Upadate"><?php esc_html_e( 'Linkage Order Collective Upadate', 'usces' ); ?>:</td>
        <td><?php echo ( $welcart_information['stocklink_collective_flag'] ) ?  esc_html_e( 'Enabled', 'usces' ) : esc_html_e( 'Disabled', 'usces' ); ?></td>
    </tr>
    <tr>
        <td data-export-label="[New] Order List"><?php esc_html_e( '[New] Order List', 'usces' ); ?>:</td>
        <td><?php echo ( $welcart_information['datalistup_orderlist_flag'] ) ?  esc_html_e( 'Enabled', 'usces' ) : esc_html_e( 'Disabled', 'usces' ); ?></td>
    </tr>
    <tr>
        <td data-export-label="[New] Member List"><?php esc_html_e( '[New] Member List', 'usces' ); ?>:</td>
        <td><?php echo ( $welcart_information['datalistup_memberlist_flag'] ) ?  esc_html_e( 'Enabled', 'usces' ) : esc_html_e( 'Disabled', 'usces' ); ?></td>
    </tr>
    <tr>
        <td data-export-label="Verify New Member Email"><?php esc_html_e( 'Verify New Member Email', 'usces' ); ?>:</td>
        <td><?php echo  ($welcart_information['verifyemail_switch_flag'] ) ?  esc_html_e( 'Enabled', 'usces' ) : esc_html_e( 'Disabled', 'usces' ); ?></td>
    </tr>
    <tr>
        <td data-export-label="Google reCAPTCHA v3"><?php esc_html_e( 'Google reCAPTCHA v3', 'usces' ); ?>:</td>
        <td><?php echo ( $welcart_information['google_recaptcha_status'] ) ? esc_html_e( 'Enabled', 'usces' ) : esc_html_e( 'Disabled', 'usces' ); ?></td>
    </tr>
    <tr>
        <td data-export-label="Brute-force attack countermeasures"><?php esc_html_e( 'Brute-force attack countermeasures', 'usces' ); ?>:</td>
        <td><?php echo ( $welcart_information['brute_force_status'] ) ? esc_html_e( 'Enabled', 'usces' ) : esc_html_e( 'Disabled', 'usces' ); ?></td>
    </tr>
    </tbody>
</table >
<table class="wc_status_table widefat" cellspacing="0">
