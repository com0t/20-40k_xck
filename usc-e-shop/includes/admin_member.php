...
<div id="member_page_setting_0">
	<div class="postbox">
		<h3><span><?php _e('Member Page Setting','usces'); ?></span><a style="cursor:pointer;" onclick="toggleVisibility('ex_member_page_setting');"><?php _e('(Explain)','usces'); ?></a></h3>
		<div class="inside">
...
<div class="postbox">
<h3><span><?php _e('Explanation in a Login page','usces'); ?></span><a style="cursor:pointer;" onclick="toggleVisibility('ex_login_page');"><?php _e('(Explain)','usces'); ?></a></h3>
<div class="inside">
<table class="form_table">
	<tr>
...
<div class="postbox">
<h3><span><?php _e('Explanation in a New Member page','usces'); ?></span><a style="cursor:pointer;" onclick="toggleVisibility('ex_newmember_page');"><?php _e('(Explain)','usces'); ?></a></h3>
<div class="inside">
<table class="form_table">
	<tr>
	    <th><?php _e('header','usces'); ?></th>
...
<div class="postbox">
<h3><span><?php _e('Explanation in New Password page','usces'); ?></span><a style="cursor:pointer;" onclick="toggleVisibility('ex_newpass_page');"><?php _e('(Explain)','usces'); ?></a></h3>
<div class="inside">
<table class="form_table">
	<tr>
	    <th><?php _e('header','usces'); ?></th>
...
<div class="postbox">
<h3><span><?php _e('Explanation in a Change Password page','usces'); ?></span><a style="cursor:pointer;" onclick="toggleVisibility('ex_changepass_page');"><?php _e('(Explain)','usces'); ?></a></h3>
<div class="inside">
<table class="form_table">
	<tr>
	    <th><?php _e('header','usces'); ?></th>
...
<div class="postbox">
<h3><span><?php _e('Explanation in a Member Information page','usces'); ?></span><a style="cursor:pointer;" onclick="toggleVisibility('ex_memberinfo_page');"><?php _e('(Explain)','usces'); ?></a></h3>
<div class="inside">
<table class="form_table">
	<tr>
	    <th><?php _e('header','usces'); ?></th>
...
<div id="member_page_setting_2">
	<div class="postbox">
	<h3><span><?php _e('Custom member field', 'usces'); ?><a style="cursor:pointer;" onclick="toggleVisibility('ex_custom_member');"><?php _e('(Explain)','usces'); ?></a></span></h3>
	<div class="inside">
