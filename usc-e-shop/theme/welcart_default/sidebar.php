	...
	<li id="welcart_login-3" class="widget widget_welcart_login">
		...
		<ul class="welcart_login_body welcart_widget_body"><li>
			...
			<?php if ( ! usces_is_login() ) { ?>
				...
				<input type="password" name="loginpass" id="loginpass" class="loginpass" value="<?php echo usces_rememberpass('return'); ?>" size="20" tabindex="20" autocomplete="off" /></label><br />
