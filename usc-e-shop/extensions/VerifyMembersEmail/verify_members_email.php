...
?>
	...
	<div class="postbox">
		<div class="postbox-header">
			<h2><span><?php _e('Verify New Member Email','usces'); ?></span><?php echo $status; ?></h2>
...
<?php
	...
	***********************************/
	public function get_verify_url($user) {
		...
		$query = array( 'verify' => $encrypt_value, 'usces_page' => 'memberverified','uscesid' => $usces->get_uscesid(false));
